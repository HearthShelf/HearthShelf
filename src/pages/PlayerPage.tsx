...
const RULE_COPY: Record<AutoRuleId, { label: string; desc: string }> = {
  ...
  manual: {
    ...
    desc: 'Play the books you added to your queue. Edit them in the list below.',
  },
}
    ...
    <div className="pp-inner">
      ...
      <div className="pp-scroll">
        ...
        {queueMode === 'off' ? (
          ...
          // Auto: the merged up-next list (rule picks + hand-added). Lives inside
          // pp-scroll so a long queue scrolls.
...
export function PlayerPage() {
  ...
  const teaseAhead = (timeSec: number) => setToast(`A note awaits at ${formatTimestamp(timeSec)}`)
  const markersEl =
